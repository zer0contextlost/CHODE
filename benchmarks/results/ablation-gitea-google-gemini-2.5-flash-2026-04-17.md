...
| Variant | Tokens | google/gemini-2.5-flash |
|---|---|---|
| full | 1970 | 61/87 (70%) |
| no-tree | 384 | 65/87 (75%) |
| no-dna | 1795 | 26/87 (30%) |
| no-context | 1765 | 58/87 (67%) |
| tree-only | 1590 | 22/87 (25%) |
| dna-only | 179 | 57/87 (66%) |
...
| Q | Topic | Category | gemini-2.5-flash full | gemini-2.5-flash no-tree | gemini-2.5-flash no-dna | gemini-2.5-flash no-context |
|---|---|---|--- | --- | --- | ---|
...
| Q15 | Authentication | Inferential | 0 | 0 | 3 | 3 |
...
| Q24 | Error handling middleware | Navigation | 0 | 3 | 0 | 0 |
| Q25 | Env var documentation | Navigation | 3 | 3 | 3 | 3 |
| Q26 | Top 3 internal packages | Deep | 2 | 2 | 1 | 2 |
