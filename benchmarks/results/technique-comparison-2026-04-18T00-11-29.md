...
| Baseline | 17% | ~300 |
| README-only | 18% | ~2956 |
| LLM Summary | 24% | ~418 (×2 API calls) |
| **CHODE** | **89%** | **~275** |

## Per-Question Detail

### caddy (~3237 tok README | ~236 tok CHODE)
...
| Q3 | `prometheus` | 3 | 3 | 0 | 0 | 0 | 0 | 3 | 3 | @API — specific integration |
| Q4 | `early return, indent` | 0 | 0 | 0 | 0 | 0 | 0 | 3 | 3 | @CONVENTIONS — tests compression quality |

### ruff (~6329 tok README | ~306 tok CHODE)

| Q | Must contain | gemini-flash base | gpt-4o base | gemini-flash readme | gpt-4o readme | gemini-flash sum | gpt-4o sum | gemini-flash chode | gpt-4o chode | Note |
|---|---|---|---|---|---|---|---|---|---|---|
| Q1 | `rust, python` | 1 | 1 | 3 | 0 | 3 | 1 | 3 | 3 | @STACK |
| Q2 | `cargo, pip` | 1 | 1 | 1 | 1 | 1 | 1 | 3 | 3 | @PKG |
| Q3 | `10, 100` | 1 | 0 | 3 | 3 | 0 | 3 | 3 | 3 | @PURPOSE — key marketing claim |
| Q4 | `test` | 0 | 2 | 0 | 0 | 0 | 0 | 2 | 2 | @CONVENTIONS — testing requirement |

### zulip (~1210 tok README | ~360 tok CHODE)
...
### pixijs (~1046 tok README | ~197 tok CHODE)
...
| Q4 | `typescript, ts` | 0 | 0 | 0 | 0 | 1 | 1 | 0 | 0 | @STACK — profile uses "ts" abbreviation |
